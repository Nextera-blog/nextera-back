"""
Django settings for nextera_API project.
...
WSGI_APPLICATION = 'nextera_API.wsgi.application'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'nextera_API.validators.CustomPasswordValidator',
    },
]
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "NexterAdmin",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "NexterAdmin",
    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "NexterAdmin",
}
