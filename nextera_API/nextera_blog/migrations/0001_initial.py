    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='articles_written', to='nextera_blog.authors')),
            ],
            options={
                'db_table': 'articles',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_date', models.DateTimeField(auto_now_add=True)),
                ('update_date', models.DateTimeField(auto_now=True)),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='nextera_blog.articles')),
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nextera_blog.authors')),
            ],
            options={
                'db_table': 'comments',
                'managed': True,
        ...
        migrations.AddField(
            model_name='articles',
            name='tags',
            field=models.ManyToManyField(related_name='articles_tagged', through='nextera_blog.ArticleTags', to='nextera_blog.tags'),
        ),
        migrations.CreateModel(
